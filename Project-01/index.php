...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">Muhammad Naufal Arif</a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="main/form.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Proect 01</p>
                                    </a>
                                </li>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card card-primary card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <h3 class="profile-username text-center">Muhammad Naufal Arif</h3>

                                    <p class="text-muted text-center">Web Development</p>

                                    <ul class="list-group list-group-unbordered mb-3">
                                        <li class="list-group-item">
                                            <b>Followers</b> <a class="float-right">12.554</a>
                                        </li>
                                        <li class="list-group-item">
                                            <b>Following</b> <a class="float-right">5.743</a>
                                        </li>
                                        <li class="list-group-item">
                                    ...
                                    <p class="text-muted text-center">IG : @nopall_donat</p>
                                </div>
                                <!-- /.card-body -->
                            </div>
                            <!-- /.card -->
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted">
                                        ...
                                        <span class="tag tag-primary">Pyhton</span>
                                    </p>
                                    ...
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="activity">
                                            ...
                                            <div class="post">
                                                ...
                                                <!-- /.user-block -->
                                                <p>
                                                    Tugas Project tertera di bagian Sidebar. Untuk sementara web ini masih mengikuti
                                                    default AdminLTE, untuk setelahnya saya akan terus memperbaharui, memasukan seluruh
                                                    data tugas yang saya buat kedalam web ini. 
                                                    Terimakasih🙏.
                                                </p>
        ...
        <footer class="main-footer">
            ...
            Edited by : Muhammad Naufal Arif
